...
export const RoomPowerLevelChanges = (() => {
    const defaults = () => ({ban: undefined,invite: undefined,kick: undefined,redact: undefined,eventsDefault: undefined,stateDefault: undefined,usersDefault: undefined,roomName: undefined,roomAvatar: undefined,roomTopic: undefined
    });
    const create = (() => {
    ...
    class FfiConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            switch (intConverter.read(from)) {
                ...
                case 5: return new QrCodeLoginError.CrossProcessRefreshLock(FfiConverterString.read(from)
                );
            
                case 6: return new QrCodeLoginError.UserIdDiscovery(FfiConverterString.read(from)
                );
            
                case 7: return new QrCodeLoginError.SessionTokens(FfiConverterString.read(from)
                );
            
                case 8: return new QrCodeLoginError.DeviceKeyUpload(FfiConverterString.read(from)
                );
            
                case 9: return new QrCodeLoginError.SecretImport(FfiConverterString.read(from)
                );
...
const FfiConverterTypeRoomMemberRole = (() => {
    ...
    class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
        read(from: RustBuffer): TypeName {
            switch (ordinalConverter.read(from)) {
                case 1: return RoomMemberRole.Administrator;
                case 2: return RoomMemberRole.Moderator;
                case 3: return RoomMemberRole.User;
                default: throw new UniffiInternalError.UnexpectedEnumCase();
            }
        }
        write(value: TypeName, into: RustBuffer): void {
            switch (value) {
                case RoomMemberRole.Administrator: return ordinalConverter.write(1, into);
                case RoomMemberRole.Moderator: return ordinalConverter.write(2, into);
                case RoomMemberRole.User: return ordinalConverter.write(3, into);
            }
        }
        allocationSize(value: TypeName): number {
            return ordinalConverter.allocationSize(0);
...
export type RoomPaginationStatus = InstanceType<
    typeof RoomPaginationStatus[keyof Omit<typeof RoomPaginationStatus, 'instanceOf'>]
>;
 ...
 * The data needed to perform authorization using OAuth 2.0.
 */
export class OAuthAuthorizationData extends UniffiAbstractObject implements OAuthAuthorizationDataInterface {
...
const uniffiTypeOAuthAuthorizationDataObjectFactory: UniffiObjectFactory<OAuthAuthorizationDataInterface> = {
    ...
    bless(p: UnsafeMutableRawPointer): UniffiRustArcPtr {
        ...
        uniffiTypeOAuthAuthorizationDataObjectFactory.registry.register(ptr, p, ptr);
        return ptr;
    },

    unbless(ptr: UniffiRustArcPtr) {
        uniffiTypeOAuthAuthorizationDataObjectFactory.registry.unregister(ptr);
    },
    ...
    clonePointer(obj: OAuthAuthorizationDataInterface): UnsafeMutableRawPointer {
