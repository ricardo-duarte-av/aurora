...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_client_clear_caches(ptr: bigint): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_client_reset_server_capabilities(ptr: bigint): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_client_url_for_oidc(ptr: bigint, oidc_configuration: Uint8Array, prompt: Uint8Array, login_hint: Uint8Array): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_build_with_qr_code(ptr: bigint, qr_code_data: bigint, oidc_configuration: Uint8Array, progress_listener: bigint): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_room_decryption_trust_requirement(ptr: bigint, trust_requirement: Uint8Array, f_status_: RustCallStatus): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_cache_size(ptr: bigint, cache_size: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_journal_size_limit(ptr: bigint, limit: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_passphrase(ptr: bigint, passphrase: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_paths(ptr: bigint, data_path: Uint8Array, cache_path: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_pool_max_size(ptr: bigint, pool_max_size: Uint8Array, f_status_: RustCallStatus): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_encryption_user_identity(ptr: bigint, user_id: Uint8Array): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_ban(ptr: bigint, user_id: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_invite(ptr: bigint, user_id: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_kick(ptr: bigint, user_id: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_pin_unpin(ptr: bigint, user_id: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_redact_other(ptr: bigint, user_id: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_redact_own(ptr: bigint, user_id: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_send_message(ptr: bigint, user_id: Uint8Array, message: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_send_state(ptr: bigint, user_id: Uint8Array, state_event: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_trigger_room_notification(ptr: bigint, user_id: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_canonical_alias(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_clear_composer_draft(ptr: bigint): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_is_public(ptr: bigint, f_status_: RustCallStatus): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_load_composer_draft(ptr: bigint): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_save_composer_draft(ptr: bigint, draft: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_send_call_notification(ptr: bigint, call_id: Uint8Array, application: Uint8Array, notify_type: Uint8Array, mentions: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_room_send_call_notification_if_needed(ptr: bigint): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_roomlistservice_subscribe_to_rooms(ptr: bigint, room_ids: Uint8Array, f_status_: RustCallStatus): void;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_constructor_span_new(file: Uint8Array, line: Uint8Array, level: Uint8Array, target: Uint8Array, name: Uint8Array, f_status_: RustCallStatus): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_audio(ptr: bigint, params: Uint8Array, audio_info: Uint8Array, progress_watcher: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_file(ptr: bigint, params: Uint8Array, file_info: Uint8Array, progress_watcher: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_image(ptr: bigint, params: Uint8Array, thumbnail_path: Uint8Array, image_info: Uint8Array, progress_watcher: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_location(ptr: bigint, body: Uint8Array, geo_uri: Uint8Array, description: Uint8Array, zoom_level: Uint8Array, asset_type: Uint8Array): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_reply(ptr: bigint, msg: bigint, reply_params: Uint8Array): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_video(ptr: bigint, params: Uint8Array, thumbnail_path: Uint8Array, video_info: Uint8Array, progress_watcher: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_voice_message(ptr: bigint, params: Uint8Array, audio_info: Uint8Array, waveform: Uint8Array, progress_watcher: Uint8Array, f_status_: RustCallStatus): bigint;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_clone_timelinediff(ptr: bigint, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_free_timelinediff(ptr: bigint, f_status_: RustCallStatus): void;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_append(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_change(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_insert(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_push_back(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_push_front(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_remove(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_reset(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_set(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
export function ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_truncate(ptr: bigint, f_status_: RustCallStatus): Uint8Array;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_func_enable_sentry_logging(enabled: number, f_status_: RustCallStatus): void;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_func_make_element_well_known(string: Uint8Array, f_status_: RustCallStatus): Uint8Array;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_func_new_virtual_element_call_widget(props: Uint8Array, f_status_: RustCallStatus): Uint8Array;
...
export function ubrn_uniffi_matrix_sdk_ffi_fn_func_suggested_power_level_for_role(role: Uint8Array, f_status_: RustCallStatus): bigint;
export function ubrn_uniffi_matrix_sdk_ffi_fn_func_suggested_role_for_power_level(power_level: bigint, f_status_: RustCallStatus): Uint8Array;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_func_enable_sentry_logging(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_func_make_element_well_known(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_client_reset_server_capabilities(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_build_with_qr_code(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_room_decryption_trust_requirement(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_cache_size(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_journal_size_limit(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_passphrase(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_paths(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_pool_max_size(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_ban(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_invite(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_kick(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_pin_unpin(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_redact_other(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_redact_own(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_send_message(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_send_state(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_trigger_room_notification(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_send_call_notification(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_send_call_notification_if_needed(): number;
...
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_append(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_change(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_insert(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_push_back(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_push_front(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_remove(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_reset(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_set(): number;
export function ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_truncate(): number;
...
export interface InitOutput {
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_account_data: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_account_url: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_account_url: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_await_room_remote_echo: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_clear_caches: (a: bigint) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_clear_caches: (a: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_create_room: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_create_room: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_custom_login_with_jwt: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_deactivate_account: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_deactivate_account: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_delete_pusher: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_delete_pusher: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_get_dm_room: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_get_media_file: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: bigint, h: bigint, i: number, j: number, k: number, l: bigint, m: bigint, n: number, o: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_get_profile: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_get_room: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_get_room_preview_from_room_alias: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_get_room_preview_from_room_alias: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_get_room_preview_from_room_id: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_get_url: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_ignore_user: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_is_room_alias_available: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_join_room_by_id: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_join_room_by_id: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_join_room_by_id_or_alias: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_knock: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_login: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_login_with_email: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_login_with_oidc_callback: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_login_with_oidc_callback: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_notification_client: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_observe_account_data_event: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_observe_room_account_data_event: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: number) => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_reset_server_capabilities: (a: bigint) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_reset_server_capabilities: (a: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_resolve_room_alias: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_resolve_room_alias: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_restore_session: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_restore_session: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_restore_session_with: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_room_alias_exists: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_room_alias_exists: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_search_users: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_set_account_data: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_set_delegate: (a: bigint, b: number, c: number, d: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_client_set_delegate: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_set_display_name: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_set_display_name: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_set_invite_avatars_display_policy: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_set_invite_avatars_display_policy: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_set_media_preview_display_policy: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_set_media_preview_display_policy: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_set_media_retention_policy: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_set_media_retention_policy: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_set_pusher: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number, r: bigint, s: bigint, t: number, u: number, v: bigint, w: bigint, x: number, y: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_start_sso_login: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_track_recently_visited_room: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_unignore_user: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_unignore_user: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_upload_avatar: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_upload_avatar: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_client_upload_media: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_client_url_for_oidc: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_client_url_for_oidc: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_add_root_certificates: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_backup_download_strategy: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_build_with_qr_code: (a: bigint, b: bigint, c: number, d: number, e: bigint) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_build_with_qr_code: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: bigint) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_cross_process_store_locks_holder_name: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_homeserver_url: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_proxy: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_proxy: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_request_config: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_request_config: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_room_decryption_trust_requirement: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_room_decryption_trust_requirement: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_room_key_recipient_strategy: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_server_name: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_server_name: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_server_name_or_homeserver_url: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_cache_size: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_cache_size: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_journal_size_limit: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_journal_size_limit: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_passphrase: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_passphrase: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_paths: (a: bigint, b: number, c: number, d: number, e: number, f: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_paths: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_pool_max_size: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_session_pool_max_size: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_sliding_sync_version_builder: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_user_agent: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_clientbuilder_username: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_clientbuilder_username: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_encryption_enable_recovery: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: bigint) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_encryption_recover: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_encryption_recover_and_reset: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_encryption_recover_and_reset: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_encryption_user_identity: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_encryption_user_identity: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_encryption_wait_for_backup_upload_steady_state: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_identityresethandle_reset: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_knockrequestactions_decline: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_knockrequestactions_decline_and_ban: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_knockrequestactions_decline_and_ban: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_mediafilehandle_persist: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_constructor_mediasource_from_json: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_constructor_mediasource_from_url: (a: number, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_constructor_mediasource_from_url: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationclient_get_notification: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_notificationclient_get_notifications: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationclient_get_notifications: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationclient_get_room: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_get_room_notification_settings: (a: number, b: bigint, c: bigint, d: number, e: number, f: number, g: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_get_rooms_with_user_defined_rules: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_get_user_defined_room_notification_mode: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_restore_default_room_notification_mode: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_set_custom_push_rule: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_set_default_room_notification_mode: (a: number, b: number, c: number, d: bigint, e: bigint, f: number, g: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_notificationsettings_set_delegate: (a: bigint, b: number, c: number, d: number) => void;
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_set_delegate: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_set_room_notification_mode: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_notificationsettings_unmute_room: (a: number, b: bigint, c: bigint, d: number, e: number, f: number, g: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_constructor_qrcodedata_from_bytes: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_apply_power_level_changes: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_ban_user: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_ban: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_ban: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_invite: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_invite: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_kick: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_kick: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_pin_unpin: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_pin_unpin: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_redact_other: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_redact_other: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_redact_own: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_redact_own: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_send_message: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_send_message: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_send_state: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_send_state: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_can_user_trigger_room_notification: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_can_user_trigger_room_notification: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_clear_composer_draft: (a: bigint) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_clear_composer_draft: (a: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_edit: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_ignore_device_trust_and_resend: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_ignore_user: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_ignore_user: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_invite_user_by_id: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_invite_user_by_id: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_is_public: (a: bigint, b: number) => number;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_is_public: (a: number, b: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_kick_user: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_load_composer_draft: (a: bigint) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_load_composer_draft: (a: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_mark_as_read: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_mark_as_read: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_matrix_to_event_permalink: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_matrix_to_event_permalink: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_member: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_member_avatar_url: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_member_avatar_url: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_member_display_name: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_member_display_name: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_member_with_sender_info: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_member_with_sender_info: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_preview_room: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_publish_room_alias_in_room_directory: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_redact: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_remove_room_alias_from_room_directory: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_report_content: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_report_room: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_report_room: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_save_composer_draft: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_save_composer_draft: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_send_call_notification: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_send_call_notification: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_send_call_notification_if_needed: (a: bigint) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_send_call_notification_if_needed: (a: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_send_live_location: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_send_live_location: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_send_raw: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_send_raw: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_set_is_favourite: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_set_is_favourite: (a: number, b: number, c: bigint, d: bigint, e: number, f: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_set_is_low_priority: (a: bigint, b: number, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_set_is_low_priority: (a: number, b: number, c: bigint, d: bigint, e: number, f: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_set_name: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_set_name: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_set_topic: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_set_topic: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_suggested_role_for_user: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_timeline_with_configuration: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_unban_user: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_update_canonical_alias: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_update_history_visibility: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_update_history_visibility: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_update_join_rules: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_update_join_rules: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_update_power_levels_for_users: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_update_power_levels_for_users: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_room_update_room_visibility: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_room_update_room_visibility: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_upload_avatar: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_room_withdraw_verification_and_resend: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_roomdirectorysearch_search: (a: number, b: bigint, c: bigint, d: number, e: number, f: number, g: bigint, h: bigint, i: number, j: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_roomlist_room: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_roomlistdynamicentriescontroller_set_filter: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_roomlistservice_room: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_roomlistservice_subscribe_to_rooms: (a: bigint, b: number, c: number, d: number) => void;
  readonly uniffi_matrix_sdk_ffi_fn_method_roomlistservice_subscribe_to_rooms: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_roommessageeventcontentwithoutrelation_with_mentions: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_sessionverificationcontroller_acknowledge_verification_request: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_sessionverificationcontroller_request_user_verification: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_sessionverificationcontroller_set_delegate: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_constructor_span_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_constructor_span_new: (a: bigint, b: bigint, c: number, d: number, e: bigint, f: bigint, g: number, h: number, i: bigint, j: bigint, k: number, l: number, m: bigint, n: bigint, o: number, p: number, q: bigint, r: bigint, s: number, t: number, u: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_ssohandler_finish: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_create_message_content: (a: number, b: number, c: bigint, d: bigint, e: number, f: number, g: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_create_poll: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: number, k: bigint, l: bigint, m: number, n: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_edit: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_edit: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_end_poll: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_end_poll: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_fetch_details_for_event: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_fetch_details_for_event: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_get_event_timeline_item_by_event_id: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_load_reply_details: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_load_reply_details: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_mark_as_read: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_mark_as_read: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_pin_event: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_redact_event: (a: bigint, b: number, c: number, d: number, e: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_redact_event: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_retry_decryption: (a: bigint, b: number, c: number, d: number) => void;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_retry_decryption: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_audio: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_audio: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_file: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_file: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_image: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_image: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number, r: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_location: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_location: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number, r: bigint, s: bigint, t: number, u: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_poll_response: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_read_receipt: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_reply: (a: bigint, b: bigint, c: number, d: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_reply: (a: number, b: number, c: bigint, d: bigint, e: number, f: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_video: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_video: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number, r: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_send_voice_message: (a: bigint, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_send_voice_message: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: bigint, o: bigint, p: number, q: number, r: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_toggle_reaction: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timeline_unpin_event: (a: bigint, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_method_timeline_unpin_event: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_clone_timelinediff: (a: bigint, b: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_clone_timelinediff: (a: number, b: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_free_timelinediff: (a: bigint, b: number) => void;
  readonly uniffi_matrix_sdk_ffi_fn_free_timelinediff: (a: number, b: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_append: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_append: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_change: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_change: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_insert: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_insert: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_push_back: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_push_back: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_push_front: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_push_front: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_remove: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_remove: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_reset: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_reset: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_set: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_set: (a: number, b: number, c: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_method_timelinediff_truncate: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_method_timelinediff_truncate: (a: number, b: number, c: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_constructor_timelineeventtypefilter_exclude: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_constructor_timelineeventtypefilter_include: (a: number, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_constructor_timelineeventtypefilter_include: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_method_widgetdriverhandle_send: (a: number, b: bigint, c: bigint, d: number, e: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_content_without_relation_from_message: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_create_caption_edit: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: bigint, k: bigint, l: number, m: number, n: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_enable_sentry_logging: (a: number, b: number) => void;
  readonly uniffi_matrix_sdk_ffi_fn_func_enable_sentry_logging: (a: number, b: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_generate_webview_url: (a: bigint, b: bigint, c: number, d: number, e: number, f: bigint, g: bigint, h: number, i: number) => bigint;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_get_element_call_required_permissions: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: bigint, h: number, i: number, j: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_init_platform: (a: number, b: number, c: number, d: number) => void;
  readonly uniffi_matrix_sdk_ffi_fn_func_init_platform: (a: bigint, b: bigint, c: number, d: number, e: number, f: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_is_room_alias_format_valid: (a: number, b: number, c: number) => number;
  readonly uniffi_matrix_sdk_ffi_fn_func_is_room_alias_format_valid: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_log_event: (a: bigint, b: bigint, c: number, d: number, e: bigint, f: bigint, g: number, h: number, i: bigint, j: bigint, k: number, l: number, m: bigint, n: bigint, o: number, p: number, q: bigint, r: bigint, s: number, t: number, u: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_make_element_well_known: (a: number, b: number, c: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_func_make_element_well_known: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_make_widget_driver: (a: number, b: number, c: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_func_make_widget_driver: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_matrix_to_room_alias_permalink: (a: number, b: number, c: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_func_matrix_to_room_alias_permalink: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_matrix_to_user_permalink: (a: number, b: number, c: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_func_matrix_to_user_permalink: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_message_event_content_from_html: (a: bigint, b: bigint, c: number, d: number, e: bigint, f: bigint, g: number, h: number, i: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_message_event_content_from_html_as_emote: (a: bigint, b: bigint, c: number, d: number, e: bigint, f: bigint, g: number, h: number, i: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_message_event_content_from_markdown: (a: number, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_func_message_event_content_from_markdown: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_message_event_content_from_markdown_as_emote: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_message_event_content_new: (a: number, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_func_message_event_content_new: (a: bigint, b: bigint, c: number, d: number, e: number) => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_new_virtual_element_call_widget: (a: number, b: number, c: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_func_new_virtual_element_call_widget: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_parse_matrix_entity_from: (a: number, b: number, c: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_func_parse_matrix_entity_from: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  ...
  readonly uniffi_matrix_sdk_ffi_fn_func_room_alias_name_from_room_display_name: (a: number, b: bigint, c: bigint, d: number, e: number, f: number) => void;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_suggested_power_level_for_role: (a: number, b: number, c: number) => bigint;
  readonly uniffi_matrix_sdk_ffi_fn_func_suggested_power_level_for_role: (a: bigint, b: bigint, c: number, d: number, e: number) => bigint;
  readonly ubrn_uniffi_matrix_sdk_ffi_fn_func_suggested_role_for_power_level: (a: bigint, b: number) => [number, number];
  readonly uniffi_matrix_sdk_ffi_fn_func_suggested_role_for_power_level: (a: number, b: bigint, c: number) => void;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_func_enable_sentry_logging: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_func_enable_sentry_logging: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_func_make_element_well_known: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_func_make_element_well_known: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_client_reset_server_capabilities: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_client_reset_server_capabilities: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_build_with_qr_code: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_build_with_qr_code: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_room_decryption_trust_requirement: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_room_decryption_trust_requirement: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_cache_size: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_cache_size: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_journal_size_limit: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_journal_size_limit: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_passphrase: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_passphrase: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_paths: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_paths: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_pool_max_size: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_clientbuilder_session_pool_max_size: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_ban: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_ban: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_invite: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_invite: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_kick: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_kick: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_pin_unpin: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_pin_unpin: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_redact_other: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_redact_other: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_redact_own: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_redact_own: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_send_message: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_send_message: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_send_state: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_send_state: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_can_user_trigger_room_notification: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_can_user_trigger_room_notification: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_send_call_notification: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_send_call_notification: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_room_send_call_notification_if_needed: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_room_send_call_notification_if_needed: () => number;
  ...
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_append: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_append: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_change: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_change: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_insert: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_insert: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_push_back: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_push_back: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_push_front: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_push_front: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_remove: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_remove: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_reset: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_reset: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_set: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_set: () => number;
  readonly ubrn_uniffi_matrix_sdk_ffi_checksum_method_timelinediff_truncate: () => number;
  readonly uniffi_matrix_sdk_ffi_checksum_method_timelinediff_truncate: () => number;
  ...
  readonly ffi_matrix_sdk_ffi_rustbuffer_from_bytes: (a: number, b: number, c: number, d: number) => void;
  readonly ffi_matrix_sdk_ffi_rustbuffer_free: (a: bigint, b: bigint, c: number, d: number, e: number) => void;
  readonly ffi_matrix_sdk_ffi_rustbuffer_reserve: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: number) => void;
  readonly ffi_matrix_sdk_ui_rustbuffer_alloc: (a: number, b: bigint, c: number) => void;
  readonly ffi_matrix_sdk_ui_rustbuffer_from_bytes: (a: number, b: number, c: number, d: number) => void;
  readonly ffi_matrix_sdk_ui_rustbuffer_free: (a: bigint, b: bigint, c: number, d: number, e: number) => void;
  readonly ffi_matrix_sdk_ui_rustbuffer_reserve: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: number) => void;
  ...
  readonly ffi_matrix_sdk_rustbuffer_from_bytes: (a: number, b: number, c: number, d: number) => void;
  readonly ffi_matrix_sdk_rustbuffer_free: (a: bigint, b: bigint, c: number, d: number, e: number) => void;
  readonly ffi_matrix_sdk_rustbuffer_reserve: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: number) => void;
  ...
  readonly ffi_matrix_sdk_base_rustbuffer_free: (a: bigint, b: bigint, c: number, d: number, e: number) => void;
  readonly ffi_matrix_sdk_base_rustbuffer_reserve: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: number) => void;
  ...
  readonly ffi_matrix_sdk_crypto_rustbuffer_from_bytes: (a: number, b: number, c: number, d: number) => void;
  readonly ffi_matrix_sdk_crypto_rustbuffer_free: (a: bigint, b: bigint, c: number, d: number, e: number) => void;
  readonly ffi_matrix_sdk_crypto_rustbuffer_reserve: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: number) => void;
  ...
  readonly ffi_matrix_sdk_common_rustbuffer_from_bytes: (a: number, b: number, c: number, d: number) => void;
  readonly ffi_matrix_sdk_common_rustbuffer_free: (a: bigint, b: bigint, c: number, d: number, e: number) => void;
  readonly ffi_matrix_sdk_common_rustbuffer_reserve: (a: number, b: bigint, c: bigint, d: number, e: number, f: bigint, g: number) => void;
  ...
  readonly closure2348_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
  readonly __externref_table_dealloc: (a: number) => void;
  readonly closure8433_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6de335fbb55c4aa5: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb32d959fd5e9f78e: (a: number, b: number) => void;
  readonly closure11544_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc7a0657e7cdacd63: (a: number, b: number) => void;
